    ...
    <section id="about" className="relative py-24 border-b brutal-border bg-background">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10 w-full max-w-7xl">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="aspect-[4/5] border-4 border-foreground dark:border-white bg-card brutal-shadow overflow-hidden group">
              <img 
            ...
            <div className="absolute -bottom-6 -right-6 hidden sm:flex flex-col items-end gap-2 pointer-events-none">
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="space-y-6">
              <p className="font-body text-xl sm:text-2xl leading-relaxed text-foreground">
